...
(cl:defmethod cl:initialize-instance :after ((m <ExchangeSh>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExchangeSh)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name commande-msg:<ExchangeSh> is deprecated: use commande-msg:ExchangeSh instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ExchangeSh>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader commande-msg:header-val is deprecated.  Use commande-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'handle-val :lambda-list '(m))
(cl:defmethod handle-val ((m <ExchangeSh>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader commande-msg:handle-val is deprecated.  Use commande-msg:handle instead.")
  (handle m))
