...
*/
	...
	ros::Subscriber sub_tache1done;
	ros::Subscriber sub_tache3done;
	ros::Subscriber sub_tache4done;
...
// Initialisation 
	...
	ros::Publisher pub_lancementTache1;
	ros::Publisher pub_lancementTache3;
	ros::Publisher pub_lancementTache4;
...
public:
	...
	void Tache1DoneCallback(const std_msgs::Int32::ConstPtr& msg);
	void Tache3DoneCallback(const std_msgs::Int32::ConstPtr& msg);
	void Tache4DoneCallback(const std_msgs::Int32::ConstPtr& msg);
